    ...
    <div className='text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32 bg-[#F6F9FC]'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    ...
                    <p className='text-sm'>
                        QuickStay is your trusted partner for unforgettable travel experiences, offering a curated selection of luxurious accommodations worldwide. Our commitment to exceptional service and personalized attention ensures that every stay is seamless and memorable. 
                    </p>
